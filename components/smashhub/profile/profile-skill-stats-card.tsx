...
export function ProfileSkillStatsCard({declaredRank, apiStats, matchStats}: ProfileSkillStatsCardProps) {
  return (
        <div className="px-4 pb-4">
          <Card className="bg-gradient-to-br from-accent to-accent/80 border-0 p-4 rounded-3xl overflow-hidden relative gap-4">
            ...
            <div className="grid grid-cols-3 gap-2 relative z-10 min-w-0">
              <div className="min-w-0 text-center px-2 py-3 rounded-2xl bg-background/10">
                <Trophy className="w-5 h-5 mx-auto mb-1 text-amber-400" />
                <p className="text-lg font-bold tabular-nums">{apiStats?.win_rate ?? 0}%</p>
                <p className="text-[10px] text-muted-foreground leading-tight">Tỷ lệ thắng</p>
              </div>
              <div className="min-w-0 text-center px-2 py-3 rounded-2xl bg-background/10">
                <Target className="w-5 h-5 mx-auto mb-1 text-blue-400" />
                <p className="text-lg font-bold tabular-nums">{matchStats?.matches_count ?? 0}</p>
                <p className="text-[10px] text-muted-foreground leading-tight">Tổng trận</p>
              </div>
              <div className="min-w-0 text-center px-2 py-3 rounded-2xl bg-background/10">
                ...
                <p className="text-[10px] text-muted-foreground leading-tight">Hạng GR</p>
              </div>
            </div>
          </Card>
        </div>
